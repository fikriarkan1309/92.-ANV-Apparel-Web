...
export const INITIAL_ORDERS: Order[] = [
  {
    ...
    sizingRoster: [],
    finishingOther: 'Sponsor dada diprint langsung sublimasi full HD.',
  },
  {
    id: 'ANV-3482',
    ...
    productType: 'Jersey atasan saja',
    fabricType: 'Dryfit Benzema',
    collarType: '12',
    quantity: 6,
    totalPrice: 1020000,
    ...
    sizingRoster: [],
    finishingOther: 'Kerah bermodel zip-up polo dengan ritsleting YKK mini.',
  },
  {
    id: 'ANV-8821',
    ...
    paymentStatus: 'Lunas',
    hasNameCheckbox: false,
    hasNumberCheckbox: true,
    roster: [
      { id: '1', name: '', number: '23', size: 'XL' },
      { id: '2', name: '', number: '0', size: 'XXL' },
      { id: '3', name: '', number: '15', size: 'XL' },
      { id: '4', name: '', number: '4', size: 'L' },
      { id: '5', name: '', number: '33', size: 'XL' },
      { id: '6', name: '', number: '8', size: 'XXL' },
      { id: '7', name: '', number: '11', size: 'L' },
      { id: '8', name: '', number: '10', size: 'M' },
      { id: '9', name: '', number: '2', size: 'XL' },
      { id: '10', name: '', number: '1', size: 'L' },
      { id: '11', name: '', number: '7', size: 'XXL' },
      { id: '12', name: '', number: '13', size: 'XL' },
    ],
    sizingRoster: [],
    finishingOther: 'Rib karet elastis di bagian lubang leher dan lengan.',
  },
  {
    id: 'ANV-4011',
    ...
    finishingOther: 'Potongan celana bersaku kanan kiri zipper tersembunyi.',
  }
];
